...
//                       <li key={i} className="hover:text-pink-500 transition-colors duration-300">
//                         {benefit}
//                       </li>
//                     ))
//                   ) : (
...
//               <p className="text-sm font-medium text-gray-600 mb-6">{plan.duration} month(s)</p>
...
//           >
//             <motion.div
//               className="bg-white rounded-3xl shadow-xl max-w-lg w-full p-8 relative"
//               initial={{ scale: 0.8 }}
//               animate={{ scale: 1 }}
//               exit={{ scale: 0.8 }}
//               transition={{ type: 'spring', stiffness: 300 }}
//             >
//               <h2 className="text-3xl font-extrabold text-purple-700 mb-6 text-center">Update Membership Plan</h2>
...
//                 <div>
//                   <label htmlFor="benefits" className="block font-semibold mb-1 text-gray-700">
...
//                   <div className="flex-1">
//                     <label htmlFor="duration" className="block font-semibold mb-1 text-gray-700">
//                       Duration (months)
//                     </label>
//                     <input
//                       type="number"
...
//                     className="px-6 py-2 rounded-md bg-gray-400 text-white font-semibold hover:bg-gray-500 transition"
//                   >
//                     Cancel
//                   </button>
//                   <button
...
export default function AllMembershipPlans() {
  ...
  const [updatingPlan, setUpdatingPlan] = useState(null);
  const [isAdmin, setIsAdmin] = useState(false);
  const [isUser, setIsUser] = useState(false);  // <-- added user state
  const [updateForm, setUpdateForm] = useState({
    name: '',
    benefits: '',
    price: '',
  ...
  const handleBuy = (plan) => {
    showToast(`You clicked buy for ${plan.name}`, 'success');
    // You can add real buy logic here later
  };
      ...
      <AnimatePresence>
        {updatingPlan && (
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold mb-6 text-purple-700">Update Membership Plan</h3>
              <form onSubmit={handleUpdateSubmit} className="space-y-5">
                <div>
                ...
                <div>
                  <label htmlFor="price" className="block font-semibold mb-1 text-gray-700">Price (₹):</label>
                  <input
                    type="number"
                    id="price"
                    name="price"
                ...
                <div>
                  <label htmlFor="duration" className="block font-semibold mb-1 text-gray-700">Duration (months):</label>
                  <input
                    type="number"
                    id="duration"
                    name="duration"
