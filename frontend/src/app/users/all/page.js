...
//                 <th className="py-3 px-6 text-left">Membership Type</th>
...
//                 >
//                   <td className="py-4 px-6 text-gray-700">{m.userId}</td>
//                   <td className="py-4 px-6 text-gray-700">{m.membershipType}</td>
            ...
            <tbody>
              {memberships.map((m) => (
                <motion.tr
                  ...
                  className="border-b border-gray-200 hover:bg-purple-50 cursor-pointer"
                >
                  <td className="py-4 px-6 text-gray-700">{m.userId?._id}</td>
